  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-2.5" noValidate>
        ...
        <Field label="Date of birth" required error={touched.dob && errors.dob} hint="Patients must be 18 or older.">
          <input
            ref={refs.dob}
            type="date"
            value={intake.dob}
        ...
        <Field label="New or returning patient" required error={touched.newOrReturning && errors.newOrReturning}>
          <div ref={refs.newOrReturning} className="flex gap-2">
            {['New', 'Returning'].map((v) => (
              <label
                key={v}
                className={
        ...
        <Field label="Reason for visit / goals (optional)">
          <textarea
            value={intake.reason}
        ...
        <Field label="How did you hear about us?" required error={touched.hearAbout && errors.hearAbout}>
          <select
            ref={refs.hearAbout}
        ...
        <Field label="Allergies, medications, or conditions (optional)">
          <textarea
