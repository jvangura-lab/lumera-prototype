...
export const PRACTITIONERS = [
  {
    ...
    initials: 'SC',
    accent: 'blush',
    specialtiesShort: 'Botox, Filler, Sculptra, Laser, PRP, CoolSculpting, Microneedling',
    bio: '12 years of experience in medical aesthetics and clinical dermatology.',
    services: ['botox', 'filler', 'sculptra', 'laser-hair', 'prp', 'coolsculpting', 'microneedling'],
  },
  {
    id: 'martinez',
    name: 'Jessica Martinez',
    credentials: 'RN, BSN — Aesthetic Nurse Injector',
    initials: 'JM',
    accent: 'gold',
    specialtiesShort: 'Botox, Filler, Sculptra, PRP, Microneedling',
    bio: 'Specializes in natural-looking injectable results.',
    services: ['botox', 'filler', 'sculptra', 'prp', 'microneedling'],
  },
  {
    id: 'reyes',
    name: 'Amanda Reyes',
    credentials: 'LE — Licensed Aesthetician',
    initials: 'AR',
    accent: 'cream',
    specialtiesShort: 'HydraFacial, Diamond Glow, Microneedling, Chemical Peel, Laser',
    bio: 'Skin-care specialist with a focus on personalized treatment plans.',
  ...
  },
  {
    ...
    initials: 'MP',
    accent: 'espresso',
    specialtiesShort: 'IV Therapy, B12, CoolSculpting, PRP',
    bio: 'Wellness and aesthetic medicine physician.',
    services: ['iv-therapy', 'b12', 'coolsculpting', 'prp'],
  },
  {
    id: 'brooks',
    name: 'Taylor Brooks',
    credentials: 'RN — Aesthetic Nurse',
    initials: 'TB',
    accent: 'blush',
    specialtiesShort: 'Botox, Filler, IV Therapy, B12',
    bio: 'Combines aesthetics and wellness for whole-body care.',
